...
class HalalPlace extends StatefulWidget {
  const HalalPlace({Key? key}) : super(key: key);

  @override
  State<HalalPlace> createState() => _HalalPlaceState();
}

class _HalalPlaceState extends State<HalalPlace> {
